{
    ...
    'data': [
        ...
        'views/vd_stringee_inbound_views.xml',
        'views/vd_pricing_views.xml',
        'views/vd_tinhnham_views.xml',
        'views/vd_quote_template_views.xml',
        'views/vd_lead_lost_wizard_views.xml',
        'views/vd_lead_no_quote_wizard_views.xml',
        'views/vd_lead_cancel_history_wizard_views.xml',
        'views/vd_lead_callback_wizard_views.xml',
        'views/vd_lead_reassign_wizard_views.xml',
        ...
        # Cron wipe intake — DISABLED (user spec: data persist mãi mãi)
        'data/cron_data.xml',
    ],
    'assets': {
        'web.assets_backend': [
            ...
            'vd_crm_lead/static/src/js/vd_num_input.js',
            'vd_crm_lead/static/src/js/vd_quote_table.js',
            ...
            'vd_crm_lead/static/src/js/vd_house_lib.js',
            'vd_crm_lead/static/src/js/vd_nghiem_thu_lib.js',
            'vd_crm_lead/static/src/js/vd_media_field.js',
            'vd_crm_lead/static/src/js/vd_broadcast_status.js',
            'vd_crm_lead/static/src/js/vd_bonus_config_board.js',
            'vd_crm_lead/static/src/xml/dashboard.xml',
            'vd_crm_lead/static/src/xml/vd_broadcast_status.xml',
            'vd_crm_lead/static/src/xml/vd_user_board.xml',
            'vd_crm_lead/static/src/xml/vd_hard_lib_button.xml',
            'vd_crm_lead/static/src/xml/vd_house_lib.xml',
            'vd_crm_lead/static/src/xml/vd_nghiem_thu_lib.xml',
            'vd_crm_lead/static/src/xml/vd_media_field.xml',
            'vd_crm_lead/static/src/xml/fb_chat.xml',
            ...
            'vd_crm_lead/static/src/xml/vd_num_input.xml',
            'vd_crm_lead/static/src/xml/vd_quote_table.xml',
            ...
            'vd_crm_lead/static/src/xml/vd_copy_user_down.xml',
            'vd_crm_lead/static/src/xml/vd_tinhnham_calc.xml',
            'vd_crm_lead/static/src/xml/vd_selection_inline.xml',
            ...
            'vd_crm_lead/static/src/scss/vd_house_lib.scss',
            'vd_crm_lead/static/src/scss/vd_nghiem_thu_lib.scss',
            'vd_crm_lead/static/src/scss/vd_media_field.scss',
            'vd_crm_lead/static/src/scss/vd_user_board.scss',
            'vd_crm_lead/static/src/scss/vd_tinhnham_calc.scss',
            'vd_crm_lead/static/src/scss/lead_form.scss',
            'vd_crm_lead/static/src/scss/responsive_overrides.scss',
            'vd_crm_lead/static/src/scss/fb_chat.scss',
        ],
    },
