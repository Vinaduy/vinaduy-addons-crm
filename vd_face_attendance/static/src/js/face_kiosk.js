...
export class VdFaceKiosk extends Component {
    setup() {
...
VdFaceKiosk.template = "vd_face_attendance.Kiosk";

registry.category("actions").add("vd_face_attendance_kiosk", VdFaceKiosk);
